...
public class StoredFeature implements Feature, Accountable, StorableElement {
    ...
    private XContentParser createParser(Object source, NamedXContentRegistry registry) throws IOException {
        if (source instanceof String) {
            return XContentType.JSON.xContent().createParser(registry, LoggingDeprecationHandler.INSTANCE, (String) source);
            ...
            return XContentType.JSON.xContent().createParser(registry, LoggingDeprecationHandler.INSTANCE, (byte[]) source);
        } else {
